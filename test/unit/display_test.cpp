...
//
// these example tests PASS but they are incorrect in their verification
//
TEST_F( unittest_DISP, disp_show_decimal_value_0 )
{
	mRc = DISP_test_namespace::disp_show_decimal( 0 );
	EXPECT_EQ( 10, mRc );
...
// these example tests PASS but they are incorrect in their verification
//
TEST_F( unittest_DISP, disp_show_decimal_value_1 )
{
	mRc = DISP_test_namespace::disp_show_decimal( 1 );
	EXPECT_EQ( 10, mRc );
